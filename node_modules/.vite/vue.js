...
var onRE = /^on[^a-z]/;
var isOn = /* @__PURE__ */ __name((key) => onRE.test(key), "isOn");
...
var def = /* @__PURE__ */ __name((obj, key, value) => {
...
function createReactiveEffect(fn, options) {
  const effect2 = /* @__PURE__ */ __name(function reactiveEffect() {
    if (!effect2.active) {
...
function trigger(target, type, key, newValue, oldValue, oldTarget) {
  ...
  const run = /* @__PURE__ */ __name((effect2) => {
...
function createGetter(isReadonly2 = false, shallow = false) {
  return /* @__PURE__ */ __name(function get2(target, key, receiver) {
...
function createSetter(shallow = false) {
  return /* @__PURE__ */ __name(function set2(target, key, value, receiver) {
...
__name(queueCb, "queueCb");
function queuePreFlushCb(cb) {
  queueCb(cb, activePreFlushCbs, pendingPreFlushCbs, preFlushIndex);
}
__name(queuePreFlushCb, "queuePreFlushCb");
...
var getId = /* @__PURE__ */ __name((job) => job.id == null ? Infinity : job.id, "getId");
...
var setCompiledSlotRendering = /* @__PURE__ */ __name((n) => isRenderingCompiledSlot += n, "setCompiledSlotRendering");
...
__name(withScopeId, "withScopeId");
...
var createHook = /* @__PURE__ */ __name((lifecycle) => (hook, target = currentInstance) => !isInSSRComponentSetup && injectHook(lifecycle, hook, target), "createHook");
...
var onErrorCaptured = /* @__PURE__ */ __name((hook, target = currentInstance) => {
...
function doWatch(source, cb, {immediate, deep, flush, onTrack, onTrigger} = EMPTY_OBJ, instance = currentInstance) {
  ...
  if (isRef(source)) {
    ...
    getter = /* @__PURE__ */ __name(() => source, "getter");
    deep = true;
    ...
    if (cb) {
      getter = /* @__PURE__ */ __name(() => callWithErrorHandling(source, instance, 2, [
        instance && instance.proxy
      ]), "getter");
    } else {
  ...
  let cleanup2;
  const onInvalidate = /* @__PURE__ */ __name((fn) => {
...
var isInternalKey = /* @__PURE__ */ __name((key) => key[0] === "_" || key === "$stable", "isInternalKey");
...
var normalizeSlot = /* @__PURE__ */ __name((key, rawSlot, ctx) => withCtx((props) => {
  if (currentInstance) {
    warn(`Slot "${key}" invoked outside of the render function: this will not track dependencies used in the slot. Invoke the slot function inside the render function instead.`);
  }
  return normalizeSlotValue(rawSlot(props));
}, ctx), "normalizeSlot");
var normalizeObjectSlots = /* @__PURE__ */ __name((rawSlots, slots) => {
...
var initSlots = /* @__PURE__ */ __name((instance, children) => {
...
var updateSlots = /* @__PURE__ */ __name((instance, children) => {
...
var isSVGContainer = /* @__PURE__ */ __name((container) => /svg/.test(container.namespaceURI) && container.tagName !== "foreignObject", "isSVGContainer");
...
function createHydrationFunctions(rendererInternals) {
  ...
  const hydrateNode = /* @__PURE__ */ __name((node, vnode, parentComponent, parentSuspense, optimized = false) => {
    const isFragmentStart = isComment(node) && node.data === "[";
    const onMismatch = /* @__PURE__ */ __name(() => handleMismatch(node, vnode, parentComponent, parentSuspense, isFragmentStart), "onMismatch");
...
- Server: ${JSON.stringify(vnode.children)}`);
      ...
      default:
        if (shapeFlag & 1) {
          ...
          const hydrateComponent = /* @__PURE__ */ __name(() => {
  ...
  const hydrateElement = /* @__PURE__ */ __name((el, vnode, parentComponent, parentSuspense, optimized) => {
...
- Server: ${vnode.children}`);
  ...
  const hydrateChildren = /* @__PURE__ */ __name((node, parentVNode, container, parentComponent, parentSuspense, optimized) => {
  ...
  const hydrateFragment = /* @__PURE__ */ __name((node, vnode, parentComponent, parentSuspense, optimized) => {
    const container = parentNode(node);
  ...
  const handleMismatch = /* @__PURE__ */ __name((node, vnode, parentComponent, parentSuspense, isFragment) => {
    hasMismatch = true;
...
- Server rendered DOM:`, node, node.nodeType === 3 ? `(text)` : isComment(node) && node.data === "[" ? `(start of fragment)` : ``);
  ...
  const locateClosingAsyncAnchor = /* @__PURE__ */ __name((node) => {
    let match = 0;
    while (node) {
...
__name(createDevEffectOptions, "createDevEffectOptions");
var queuePostRenderEffect = queueEffectWithSuspense;
var setRef = /* @__PURE__ */ __name((rawRef, oldRawRef, parentSuspense, vnode) => {
  if (isArray(rawRef)) {
...
function baseCreateRenderer(options, createHydrationFns) {
  ...
  const patch = /* @__PURE__ */ __name((n1, n2, container, anchor = null, parentComponent = null, parentSuspense = null, isSVG = false, optimized = false) => {
  ...
  const mountStaticNode = /* @__PURE__ */ __name((n2, container, anchor, isSVG) => {
    [n2.el, n2.anchor] = hostInsertStaticContent(n2.children, container, anchor, isSVG);
  }, "mountStaticNode");
  const patchStaticNode = /* @__PURE__ */ __name((n1, n2, container, isSVG) => {
    if (n2.children !== n1.children) {
  ...
  const processElement = /* @__PURE__ */ __name((n1, n2, container, anchor, parentComponent, parentSuspense, isSVG, optimized) => {
  ...
  const mountElement = /* @__PURE__ */ __name((vnode, container, anchor, parentComponent, parentSuspense, isSVG, optimized) => {
    let el;
    let vnodeHook;
  ...
  const setScopeId = /* @__PURE__ */ __name((el, scopeId, vnode, parentComponent) => {
    if (scopeId) {
  ...
  const mountChildren = /* @__PURE__ */ __name((children, container, anchor, parentComponent, parentSuspense, isSVG, optimized, start = 0) => {
    for (let i = start; i < children.length; i++) {
      const child = children[i] = optimized ? cloneIfMounted(children[i]) : normalizeVNode(children[i]);
      patch(null, child, container, anchor, parentComponent, parentSuspense, isSVG, optimized);
    }
  }, "mountChildren");
  const patchElement = /* @__PURE__ */ __name((n1, n2, parentComponent, parentSuspense, isSVG, optimized) => {
    const el = n2.el = n1.el;
  ...
  const patchBlockChildren = /* @__PURE__ */ __name((oldChildren, newChildren, fallbackContainer, parentComponent, parentSuspense, isSVG) => {
  ...
  const patchProps = /* @__PURE__ */ __name((el, vnode, oldProps, newProps, parentComponent, parentSuspense, isSVG) => {
  ...
  const processFragment = /* @__PURE__ */ __name((n1, n2, container, anchor, parentComponent, parentSuspense, isSVG, optimized) => {
  ...
  const processComponent = /* @__PURE__ */ __name((n1, n2, container, anchor, parentComponent, parentSuspense, isSVG, optimized) => {
    if (n1 == null) {
      if (n2.shapeFlag & 512) {
  ...
  const mountComponent = /* @__PURE__ */ __name((initialVNode, container, anchor, parentComponent, parentSuspense, isSVG, optimized) => {
  ...
  const setupRenderEffect = /* @__PURE__ */ __name((instance, initialVNode, container, anchor, parentSuspense, isSVG, optimized) => {
    instance.update = effect(/* @__PURE__ */ __name(function componentEffect() {
    ...
    }, "componentEffect"), true ? createDevEffectOptions(instance) : prodEffectOptions);
  }, "setupRenderEffect");
  ...
  const patchChildren = /* @__PURE__ */ __name((n1, n2, container, anchor, parentComponent, parentSuspense, isSVG, optimized = false) => {
  ...
  const patchUnkeyedChildren = /* @__PURE__ */ __name((c1, c2, container, anchor, parentComponent, parentSuspense, isSVG, optimized) => {
    c1 = c1 || EMPTY_ARR;
    c2 = c2 || EMPTY_ARR;
  ...
  const patchKeyedChildren = /* @__PURE__ */ __name((c1, c2, container, parentAnchor, parentComponent, parentSuspense, isSVG, optimized) => {
    let i = 0;
    const l2 = c2.length;
    let e1 = c1.length - 1;
    let e2 = l2 - 1;
  ...
  const move = /* @__PURE__ */ __name((vnode, container, anchor, moveType, parentSuspense = null) => {
    ...
    if (needTransition) {
      if (moveType === 0) {
        ...
        const remove3 = /* @__PURE__ */ __name(() => hostInsert(el, container, anchor), "remove");
  ...
  const render2 = /* @__PURE__ */ __name((vnode, container) => {
    if (vnode == null) {
      if (container._vnode) {
...
var isTargetSVG = /* @__PURE__ */ __name((target) => typeof SVGElement !== "undefined" && target instanceof SVGElement, "isTargetSVG");
...
var normalizeRef = /* @__PURE__ */ __name(({ref: ref2}) => {
...
__name(callSyncHook, "callSyncHook");
...
__name(callHookFromExtends, "callHookFromExtends");
...
__name(callHookFromMixins, "callHookFromMixins");
...
__name(recordInstanceBoundEffect, "recordInstanceBoundEffect");
...
if (typeof document !== "undefined" && _getNow() > document.createEvent("Event").timeStamp) {
  _getNow = /* @__PURE__ */ __name(() => performance.now(), "_getNow");
}
var cachedNow = 0;
...
var getNow = /* @__PURE__ */ __name(() => cachedNow || (p.then(reset), cachedNow = _getNow()), "getNow");
...
var forcePatchProp = /* @__PURE__ */ __name((_, key) => key === "value", "forcePatchProp");
var patchProp = /* @__PURE__ */ __name((el, key, prevValue, nextValue, isSVG = false, prevChildren, parentComponent, parentSuspense, unmountChildren) => {
  switch (key) {
    case "class":
...
function useCssVars(getter) {
  ...
  const setVars = /* @__PURE__ */ __name(() => setVarsOnVNode(instance.subTree, getter(instance.proxy)), "setVars");
...
var Transition = /* @__PURE__ */ __name((props, {slots}) => h(BaseTransition, resolveTransitionProps(props), slots), "Transition");
...
var withModifiers = /* @__PURE__ */ __name((fn, modifiers) => {
  return (event, ...args) => {
...
var withKeys = /* @__PURE__ */ __name((fn, modifiers) => {
  return (event) => {
    if (!("key" in event))
      return;
...
var hydrate = /* @__PURE__ */ __name((...args) => {
  ensureHydrationRenderer().hydrate(...args);
}, "hydrate");
var createApp = /* @__PURE__ */ __name((...args) => {
...
__name(injectCustomElementCheck, "injectCustomElementCheck");
